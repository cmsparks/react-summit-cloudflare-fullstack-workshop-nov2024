...
```tsx
/* TODO (2): add loader and action */

export default function Index() {
  const cardDetails = /* TODO (3): properly implement */ {
...
- in order to work on this let's start by commenting out the `cardDetails` declaration and replacing it with `const cardDetails = null`
